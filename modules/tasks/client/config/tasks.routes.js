(function () {
  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('tasks.list', {
        url: '',
        templateUrl: 'modules/tasks/client/views/list-tasks..html',
      ...
      .state('tasks.create', {
        url: '/create',
        templateUrl: 'modules/tasks/client/views/form-task..html',
      ...
      .state('tasks.view', {
        url: '/:taskId',
        templateUrl: 'modules/tasks/client/views/view-task..html',
        controller: 'TasksController',
        controllerAs: 'vm',
        resolve: {
          taskResolve: getTask

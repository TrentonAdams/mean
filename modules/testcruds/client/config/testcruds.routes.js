  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('testcruds.list', {
        url: '',
        templateUrl: 'modules/testcruds/client/views/list-testcruds.html',
      ...
      .state('testcruds.create', {
        url: '/create',
        templateUrl: 'modules/testcruds/client/views/form-testcrud.html',
      ...
      .state('testcruds.view', {
        url: '/:testcrudId',
        templateUrl: 'modules/testcruds/client/views/view-testcrud.html',
        controller: 'TestcrudsController',
        controllerAs: 'vm',
        resolve: {
          testcrudResolve: getTestcrud
        ...
        data: {
          pageTitle: 'Testcrud {{ testcrudResolve.name }}'
        }
      });
  }

    ...
    describe('Route Config', function () {
      ...
      describe('View Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('modules/testcruds/client/views/view-testcrud.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(viewstate.templateUrl).toBe('modules/testcruds/client/views/view-testcrud.html');
        });
      });
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('modules/testcruds/client/views/form-testcrud.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/testcruds/client/views/form-testcrud.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('modules/testcruds/client/views/form-testcrud.html');
        });
